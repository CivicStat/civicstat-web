...
import { getScopedMotions } from "../../../../lib/api";
...
export const metadata = {
  title: "Moties — Eerste Kamer",
  description:
    "Wetsvoorstellen en moties in de Eerste Kamer met stemresultaten.",
};

export default async function EKMotiesPage({
  searchParams,
}: {
  ...
  let data;
  try {
    data = await getScopedMotions(SLUG, {
      status: sp.status,
      q: sp.q,
      limit: PAGE_SIZE,
      offset,
  ...
  return (
    <div className="mx-auto max-w-[1200px] px-5 py-7 pb-24">
      ...
      <p className="text-sm text-text-secondary leading-relaxed mb-5">
        {total.toLocaleString("nl-NL")} wetsvoorstellen en moties in de Eerste
        Kamer.
      </p>
...
function PagLink({
  ...
  return (
    <Link
      href={`${routes.ek.moties}?${sp.toString()}`}
